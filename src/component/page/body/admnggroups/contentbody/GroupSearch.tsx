				...
				<dl>
					...
					<Dd>
						<Input style={{width: 300}} type="text" placeholder="그룹명을 입력해주세요" value={adGroupNameSearchKeyword}
						       ...
						       onPressEnter={() => updateAdGroups(adGroupNameSearchKeyword, setAdGroups)}
						/>
					</Dd>
					<div className="box-right"><Dd><Button type="primary" className="gray" onClick={() => updateAdGroups(adGroupNameSearchKeyword, setAdGroups)}>그룹 조회</Button></Dd></div>
				</dl>
			</SectionBody>
		</section>
	);
